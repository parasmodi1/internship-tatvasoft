...
INSERT INTO students (first_name, last_name, gender, email) VALUES (
    'Neel', 'Darji', 'Male', 'neeldarji@gmail.com');
...
FROM
	students
WHERE
	first_name = 'Neel' AND last_name = 'Darji';
...
--sub query
SELECT * from results
where student_id IN (select student_id from students where first_name='Neel')
