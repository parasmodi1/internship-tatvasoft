...
namespace Web_API.Controllers
{
    ...
    {       
        ...
        public async Task<ResponseResult> GetUserProfileDetailById(int id)
        {
            try
            {
                result.Data = await _balLogin.LoginUserDetailById(id);
                result.Result = ResponseStatus.Success;
            }catch (Exception ex)
            {
                result.Result= ResponseStatus.Error;
        ...
        public async Task<ResponseResult> LoginUserDetailById(int id)
        {
            try
            {
                result.Data = await _balLogin.LoginUserDetailById(id);
